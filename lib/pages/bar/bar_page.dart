      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            boissonProvider.boissons.isEmpty
                ? SizedBox(
                    height: 140.0,
                    child: Column(
                    ...
                    child: Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return BoissonBox(
                            boisson: boissonProvider.boissons[index],
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
            ...
            CasierUtil.getRecentsCasiers(casierProvider.casiers).isEmpty
                ? SizedBox(
                    height: 160.0,
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                ...
                : SizedBox(
                    ...
                    child: Expanded(
                      child: ListView.builder(
                        itemCount:
                            CasierUtil.getRecentsCasiers(casierProvider.casiers)
                                .take(10)
                                .toList()
                                .length,
                        scrollDirection: Axis.horizontal,
                        itemBuilder: (context, index) {
                          return CasierBox(
                            casier: CasierUtil.getRecentsCasiers(
                                    casierProvider.casiers)
                                .take(10)
                                .toList()[index],
                            onTap: () => Navigator.push(
                              context,
