...
class BoissonDetailScreen extends StatefulWidget {
  final Boisson boisson;

  const BoissonDetailScreen({super.key, required this.boisson});

  @override
  State<BoissonDetailScreen> createState() => _BoissonDetailScreenState();
}

class _BoissonDetailScreenState extends State<BoissonDetailScreen> {
                      ...
                      Row(
                        ...
                        children: [
                          ElevatedButton.icon(
                            ...
                            onPressed: () => _modifierBoisson(provider),
                          ),
                          ElevatedButton.icon(
                            ...
                            onPressed: () => _supprimerBoisson(provider),
                          ),
                        ],
                      ),
                    ],
