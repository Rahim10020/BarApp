...
class CasierDetailSansModifScreen extends StatefulWidget {
  final Casier casier;

  const CasierDetailSansModifScreen({super.key, required this.casier});

  @override
  State<CasierDetailSansModifScreen> createState() =>
      _CasierDetailSansModifScreenState();
}

class _CasierDetailSansModifScreenState
    extends State<CasierDetailSansModifScreen> {
