  ...
  Future<void> _changePin() async {
    ...
    if (_newPinController.text.length < 4) {
      context.showWarningSnackBar(
          'Le nouveau code PIN doit contenir au moins 4 chiffres');
      return;
    }
    ...
    try {
      ...
      final isOldPinCorrect =
          await _authService.authenticateWithPin(_oldPinController.text);
          ...
          child: Column(
            ...
            children: [
              ...
              AppButton.primary(
                ...
                isFullWidth: true,
                onPressed:
                    (_isLoading || !_areAllFieldsFilled) ? null : _changePin,
